        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (Reader r = Reader.Create(args[0]))
                {
                    ...
                    TagData t = new TagData("E20068070000000000000000");

                    SimpleReadPlan plan = new SimpleReadPlan(antennaList, TagProtocol.GEN2, t, null, 1000); ;
                    // Set the created readplan
                    r.ParamSet("/reader/read/plan", plan);

                    // Read tags
                    TagReadData[] tagReads = r.Read(100);
